...
void setup() {
  ...
  ip = "12345";
  address = "/openbci";
  networkType = 2;  // 1:udp; 2:osc; 3:lsl;
...
//            if (networkType !=0){
//              if (nchan==8){
//                // println("sending packet on network");
//                sendRawData_dataPacket(dataPacketBuff[lastReadDataPacketInd], openBCI.get_scale_fac_uVolts_per_count(0), openBCI.get_scale_fac_accel_G_per_count());
//              }else if ((nchan==16) && ((dataPacketBuff[lastReadDataPacketInd].sampleIndex %2)!=1)){
//                sendRawData_dataPacket(dataPacketBuff[lastReadDataPacketInd], openBCI.get_scale_fac_uVolts_per_count(0), openBCI.get_scale_fac_accel_G_per_count());
//              }
//            }
            break;
...
//      if (networkType !=0){
//        if (nchan==8){
//          sendRawData_dataPacket(dataPacketBuff[curDataPacketInd], openBCI.get_scale_fac_uVolts_per_count(0), openBCI.get_scale_fac_accel_G_per_count());
